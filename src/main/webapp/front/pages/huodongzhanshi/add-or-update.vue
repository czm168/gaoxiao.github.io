	...
	<view class="content">
		<form class="app-update-pv">
			...
			<!-- 否 -->
				...
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">活动内容</view>
				<textarea :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"280rpx"}' v-model="ruleForm.huodongneirong" placeholder="活动内容"></textarea>
			</view>
	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`huodongzhanshi`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
																																																																																																																																																																																																																																																																																																								if(this.ruleForm.id){
					await this.$api.update(`huodongzhanshi`, this.ruleForm);
				}else{
					await this.$api.add(`huodongzhanshi`, this.ruleForm);
				}
