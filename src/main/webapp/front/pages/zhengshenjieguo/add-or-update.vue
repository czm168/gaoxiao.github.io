	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`zhengshenjieguo`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																				...
																																				if(this.ruleForm.id){
					await this.$api.update(`zhengshenjieguo`, this.ruleForm);
				}else{
					await this.$api.add(`zhengshenjieguo`, this.ruleForm);
				}
