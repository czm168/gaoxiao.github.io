...
public class DangyuanxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,DangyuanxinxiEntity dangyuanxinxi, 
		...
		if(tableName.equals("yonghu")) {
			dangyuanxinxi.setZhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DangyuanxinxiEntity dangyuanxinxi, HttpServletRequest request){
